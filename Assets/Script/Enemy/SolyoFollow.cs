...
using UnityEngine;
public class SolyoFollow : MonoBehaviour
{
    [SerializeField]
    public Transform player;
    public Transform Kerumunan;
    ...
    void Update()
    {
        ...
        float distance1 = Vector2.Distance(transform.position, Kerumunan.position);
    ...
    {
        if (transform.position.x < Kerumunan.position.x)
        {
            rb.velocity = new Vector2(speed, 0);
            transform.localScale = new Vector2(1, 1);
        }
